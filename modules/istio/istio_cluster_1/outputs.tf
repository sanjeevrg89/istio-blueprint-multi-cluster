/* output "ingress_gateway_cluster1_status" {
...
output "ingress_gateway_cluster1_version" {
...
output "ingress_gateway_cluster1_load_balancer_url" {
  description = "Load Balancer URL for the Istio Ingress Gateway in Cluster 1"
